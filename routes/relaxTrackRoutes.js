...
relaxTrackRoute.get('/allRelaxTracks', (req, res)=>{
    
    const trackDB = result.db('breathing-app-relaxDB')
...
// GET  /api/relax/upload/trackName --uploading to db (Testing)-replace trackName with audio file name in local system.
relaxTrackRoute.get('/upload/:trackName', (req, res) => {
...
// GET  /api/relax/download/trackName  --fetching perticular audio file from db by replacing trackName in url with filename in database
relaxTrackRoute.get('/download/:trackName', (req, res) => {
